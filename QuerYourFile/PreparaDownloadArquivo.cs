...
namespace QuerYourFile {
    sealed class PreparaDownloadArquivo {
        /// <summary>
        /// Definição do padrão Singleton:
        /// </summary>
        private static readonly PreparaDownloadArquivo instancia = new PreparaDownloadArquivo();
        private PreparaDownloadArquivo() { }
        public static PreparaDownloadArquivo GetInstancia() {
            return instancia;
        }

        ManipulaArquivoTXT manipulaArquivoTXT = ManipulaArquivoTXT.GetInstancia();
        ManipulaArquivoXLSX manipulaArquivoXLSX = ManipulaArquivoXLSX.GetInstancia();
